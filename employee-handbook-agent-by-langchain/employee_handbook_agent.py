"""
LangChain-based Employee Handbook RAG Agent

This application uses LangChain to create a RAG (Retrieval-Augmented Generation)
system that answers questions about company policies based on a PDF employee handbook.
...
class EmployeeHandbookAgent:
    """
    A RAG agent that answers questions about employee policies based on a PDF handbook.
    """
    ...
    def __init__(
        ...
        """
        Initialize the Employee Handbook Agent.
        
        Args:
            pdf_path: Path to the PDF employee handbook
    ...
    def load_and_index_pdf(self, force_reload: bool = False):
        ...
        if not Path(self.pdf_path).exists():
            raise FileNotFoundError(
                ...
                f"   Please place your employee handbook PDF at this location."
            )
    ...
    def _setup_retriever(self):
        ...
        template = """你是一个专业的员工手册问答助手，基于员工手册内容回答关于公司政策的问题。

请根据以下员工手册的上下文来回答问题。如果在提供的上下文中找不到答案，请明确说明。
...
def main():
    ...
    print("="*60)
    print("🤖 Employee Handbook Agent (LangChain)")
    print("="*60)
    print()
    ...
    try:
        ...
        # Demo 1: 关于年假的核心问题（与原始 Agno 示例对应）
        print("\n📋 演示问题 1: 关于年假政策")
        print("-" * 60)
        agent.ask(
            "公司的年假政策是什么？",
        ...
        print("="*60)
        print("\n💡 下一步建议:")
        print("   1. 运行交互式版本: python interactive_agent.py")
        print("   2. 修改代码尝试不同问题")
        print("   3. 阅读 LANGCHAIN_GUIDE.md 学习更多\n")
